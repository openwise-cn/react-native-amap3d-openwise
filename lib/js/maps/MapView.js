...
export default class MapView extends Component<any> {
  static propTypes = {
     ...
     * }}
     */
    onGeocodeSearched: PropTypes.func,
     ...
     * }}
     */
    onRegeocodeSearched: PropTypes.func,
  }
  ...
  animateBound(markers: Array<LatLng>) {
    this.sendCommand('animateBound', [markers])
  }

  getLatLng(name: String, city: String) {
    this.sendCommand('getLatLng', [ name, city ])
  }

  getAddress(latitude: number, longitude: number) {
    this.sendCommand('getAddress', [latitude, longitude])
  }
